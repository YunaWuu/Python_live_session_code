...
# It is possible to modify a method in a child class
# that it has inherited from the parent class.

# This process of re-implementing a method in the child
...
class Staff(Person):
    ...
    def hello(self):
        return f'Hello staff member {self.firstname}'
...
class Customer(Person):
    ...
    def hello(self):
        return f'Hello loyal customer {self.firstname}'
...
# hello method is overridden in child classes
